...
<div class="row">
  ...
  <div class="panel panel-default">
            <div class="panel-heading">
              <h4 class="panel-title">Add Pricing / Currency</h4>
            </div>
            <?php // Change the css classes to suit your needs    

$attributes = array('class' => 'form-horizontal', 'id' => 'basicForm2', 'novalidate'=>'novalidate');
echo form_open('settings/add_pricing_currency/'.$this->session->userdata('session_user_com'), $attributes); ?>
            ...
            <div class="panel-body">
              <div class="row row-pad-5">
                ...
                <div class="col-lg-9">
                <input id="pricing_name" type="text" name="pricing_name" maxlength="30" class="form-control" value="<?php echo set_value('pricing_name'); ?>"  />
                <br/>
