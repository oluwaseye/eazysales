  ...
  <div class="col-md-3">
    <div class="leftpanelinner">    
        ...
        <ul class="nav nav-tabs nav-dark">
          <li class="active"><a href="<?php echo base_url().'settings/'.$this->session->userdata('session_user_com');?>" ><strong>Business Info</strong></a></li>
...
echo form_open('settings/business_update/'.$company_id->comp_id, $attributes); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input id="company_name" type="text" class="form-control" placeholder="Company Name" name="company_name" maxlength="100" required="" value="<?php if(set_value('company_name')){ echo set_value('company_name');}else{echo $company_id->company_name;} ?>"  />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input id="contact_email" type="email" class="form-control" title="Your email address is required!" placeholder="Type your email..." required="" name="contact_email" maxlength="50" value="<?php if(set_value('contact_email')){ echo set_value('contact_email');}else{echo $company_id->contact_email;} ?>"  />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input id="website" type="url" name="website" value="<?php if(set_value('website')){ echo set_value('website');}else{echo $company_id->website;} ?>"  title="Please enter a valid url!" class="form-control"/>
           ...
           value="<?php echo set_value('contact_address'); ?>"   required=""><?php if(set_value('contact_address')){ echo set_value('contact_address');}else{echo $company_id->contact_address;} ?></textarea>
                ...
                <div class="form-group">
                  ...
                  <input id="city" type="text" class="form-control" 
                   ...
                   value="<?php if(set_value('city')){ echo set_value('city');}else{echo $company_id->city;} ?>"  />
                ...
                <div class="form-group">
                  ...
                  <input id="state_region" type="text" class="form-control" placeholder="State/Region" required="" name="state_region"
                   maxlength="50" value="<?php if(set_value('state_region')){ echo set_value('state_region');}else{echo $company_id->state_region;} ?>"  />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                         <?php $options = array(
                                                  $company_id->country  => $company_id->country,
                                                  'nigeria'    => 'Nigeria',
                                                  'ghana'    => 'Ghana'
                                                ); ?>
