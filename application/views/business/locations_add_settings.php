  ...
  <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <div class="panel-body">
         <?php 
          ...
          echo form_open('settings/add_location/'.$this->session->userdata('session_user_com'), $attributes); ?>
            <div class="panel panel-default">
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="location_name" class="form-control" value="<?php echo set_value('location_name'); ?>">
