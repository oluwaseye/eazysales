...
<div class="row">
  ...
  <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        echo form_open('settings/add_address/'.$this->session->userdata('session_user_com'), $attributes); ?>
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">Receiving Addresses</h4>
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <div class="form-group">
                  <div class="col-sm-12">
                   <?php echo form_textarea( array( 'name' => 'address', 'placeholder'=>'Receiving Address', 'class'=>'form-control', 'rows' => '5', 'cols' => '80', 'value' => set_value('address') ) )?>
