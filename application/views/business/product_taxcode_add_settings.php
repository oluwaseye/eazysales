...
<div class="row">
  ...
  <div class="panel panel-default">
            <div class="panel-heading">
              <h4 class="panel-title">Add Product Tax Codes</h4>
            </div>
            <?php // Change the css classes to suit your needs    

$attributes = array('class' => 'form-horizontal', 'id' => 'basicForm2', 'novalidate'=>'novalidate');
echo form_open('settings/add_product_tax_code/'.$this->session->userdata('session_user_com'), $attributes); ?>
            ...
            <div class="panel-body">
              <div class="row row-pad-5">
                ...
                <div class="col-lg-9">
                <input id="name" type="text" name="name" maxlength="30" class="form-control" value="<?php echo set_value('name'); ?>"  />
                <br/>
            ...
            <div class="row row-pad-5">
                ...
                <div class="col-lg-9">
                  <input id="code" type="text" name="code" maxlength="30" value="<?php echo set_value('code'); ?>"  />
                   <br/>
            ...
            <div class="row row-pad-5">
               ...
               <input id="primary_tax_applicable" name="primary_tax_applicable" type="radio" class="" value="1" <?php echo $this->form_validation->set_radio('primary_code_applicable', '1'); ?> />      
               <label for="primary_tax_applicable" class="">Yes</label>
                        <input id="primary_tax_applicable" name="primary_tax_applicable" type="radio" class="" value="0" <?php echo $this->form_validation->set_radio('primary_code_applicable', '0'); ?> />
            ...
            <div class="row row-pad-5">
                <div class="col-lg-3">
                  <h5>Secondary Tax Applicable</h5>
                    ...
                    <div class="col-lg-9">
                   <div class="checkbox block">
               <input id="secondary_tax_applicable" name="secondary_tax_applicable" type="radio" class="" value="1" <?php echo $this->form_validation->set_radio('secondary_tax_applicable', '1'); ?> />      
               <label for="secondary_tax_applicable" class="">Yes</label>
                        <input id="secondary_tax_applicable" name="secondary_tax_applicable" type="radio" class="" value="0" <?php echo $this->form_validation->set_radio('secondary_tax_applicable', '0'); ?> />
