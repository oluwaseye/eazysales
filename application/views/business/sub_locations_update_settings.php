  ...
  <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <div class="panel-body">
         <?php 
          ...
          echo form_open('settings/update_sub_location/'.$sub_location->location_id.'/'.$sub_location->id.'/'.$this->session->userdata('session_user_com'), $attributes); ?>
            <div class="panel panel-default">
              ...
              <a href="<?php echo base_url().'settings/sub_locations/'. $loc_settings->id.'/'.$this->session->userdata('session_user_com');?>" class="btn btn-info btn-sm pull-right"><i class="fa fa-list-alt"></i> Sub Locations</a>
                <h4 class="panel-title">Update Sub Locations</h4>
              ...
              <div class="panel-body panel-body-nopadding">
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="sub_location_name" class="form-control" value="<?php echo $sub_location->name ?>">
