...
echo form_open('settings/add_taxing_scheme/'.$this->session->userdata('session_user_com'), $attributes); ?>
            ...
            <div class="panel-body">
              <div class="row row-pad-5">
                ...
                <div class="col-lg-9">
                <input id="scheme_name" type="text" name="scheme_name" maxlength="30" class="form-control" value="<?php echo set_value('scheme_name'); ?>"  />
                <br/>
            ...
            <div class="row row-pad-5">
                ...
                <div class="col-lg-9">
                  <input id="primary_tax_name" type="text" name="primary_tax_name" maxlength="30" class="form-control"  value="<?php echo set_value('primary_tax_name'); ?>"  />
                   <br/>
                ...
                <div class="input-group mb15 col-sm-2">
                   <input id="primary_tax_rate" type="text" name="primary_tax_rate" maxlength="2" class="form-control"  value="<?php echo set_value('primary_tax_rate'); ?>"  />
                ...
                <div class="col-lg-9">
                  <input id="secondary_tax_name" type="text" name="secondary_tax_name" maxlength="30"  class="form-control" value="<?php echo set_value('secondary_tax_name'); ?>"  />
                   <br/>
                ...
                <div class="col-lg-9">
                  <div class="input-group mb15 col-sm-2">
                    <input id="secondary_tax_rate" type="text" name="secondary_tax_rate" maxlength="3" class="form-control"  value="<?php echo set_value('secondary_tax_rate'); ?>"  />
                  <span class="input-group-addon">%</span>
                </div>
            ...
            <div class="row row-pad-5">
               ...
               <input id="comp_sec_tax_primary" name="comp_sec_tax_primary" type="radio" class="" value="1" <?php echo $this->form_validation->set_radio('comp_sec_tax_primary', '1'); ?> />      
               <label for="comp_sec_tax_primary" class="">Yes</label>
                        <input id="comp_sec_tax_primary" name="comp_sec_tax_primary" type="radio" class="" value="0" <?php echo $this->form_validation->set_radio('comp_sec_tax_primary', '0'); ?> />
            ...
            <div class="row row-pad-5">
                <div class="col-lg-3">
                  <h5>Tax on Shipping</h5>
                    ...
                    <div class="col-lg-9">
                   <div class="checkbox block">
               <input id="tax_shipping" name="tax_shipping" type="radio" class="" value="1" <?php echo $this->form_validation->set_radio('tax_shipping', '1'); ?> />      
               <label for="tax_shipping" class="">Yes</label>
                        <input id="tax_shipping" name="tax_shipping" type="radio" class="" value="0" <?php echo $this->form_validation->set_radio('tax_shipping', '0'); ?> />
