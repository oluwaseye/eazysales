<div class="col-md-12 mb20">
   <div class="pageheader">
      <h2><i class="fa fa-user"></i> Product Vendors </h2>
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Product Vendors</li>
        </ol>
      ...
      <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="<?php echo base_url().'inventory/product_vendors/'.$this->session->userdata('session_user_com');?>"><strong>Product Vendors </strong></a></li>
