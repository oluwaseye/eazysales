<div class="col-md-12 mb20">
   <div class="pageheader">
      <h2><i class="fa fa-user"></i> Vendor Products</h2>
      ...
      <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="<?php echo base_url().'vendor/vendor_products/'.$this->session->userdata('session_user_com');?>"><strong>Vendor Products</strong></a></li>
