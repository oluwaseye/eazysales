<div class="col-md-12 mb20">
   <div class="pageheader">
      <h2><i class="fa fa-user"></i> Update Customer <a href="<?php echo base_url().'customers/business/'.$this->session->userdata('session_user_com');?>" class="btn btn-info pull-right"><i class="fa fa-list-alt"></i> Customers</a>
          </h2>
    ...
    if($custom_error)print_r($custom_error);?>
        ...
        <?php 
          ...
          echo form_open('customers/update_customer/'.$result->id.'/'.$this->session->userdata('session_user_com'), $attributes); ?>
              ...
              <div class="col-sm-6">
               ...
               <hr/>
                ...
                <div class="col-sm-6">
                  ...
                  <option <?php if($cus_location->id == $result->loc_id) echo 'selected'; if(set_value('loc_id')){ echo set_value('loc_id');}?> value="<?php echo $cus_location->id; ?>"><?php echo $cus_location->name; ?></option>
                <?php endforeach ?>
                </select>
                <?php echo form_error('loc_id'); ?>
                  </div>
